...
const TermsPage = () => {
  ...
  return (
    <Wrapper>
      <SEO title="Terms and Conditions" pathname="/terms" />
      ...
      <p>
        ...
        <StyledOutboundLink target="_blank" href="https://www.termsandconditionsgenerator.com">
      ...
      <p>
        ...
        <Link to="/disclaimer">Disclaimer Notice</Link> and all Agreements: &quot;Client&quot;,
      ...
      <Byline>License</Byline>

      <p>
        Unless otherwise stated, {title} and/or its licensors own the intellectual property rights
        for all material on {title}. All intellectual property rights are reserved. You may access
        this from {title} for your own personal use subjected to restrictions set in these terms and
        conditions.
      </p>
      ...
      <p>
        ...
        information in certain areas of the website. {title} does not filter, edit, publish or
        review Comments prior to their presence on the website. Comments do not reflect the views
        and opinions of {title},its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, {title} shall not be liable for the Comments or for any liability, damages
        or expenses caused and/or suffered as a result of any use of and/or posting of and/or
        appearance of the Comments on this website.
      </p>

      <p>
        {title} reserves the right to monitor all Comments and to remove any Comments which can be
      ...
      <p>
        You hereby grant {title} a non-exclusive license to use, reproduce, edit and authorize
        others to use, reproduce and edit any of your Comments in any and all forms, formats or
        media.
      </p>

      <Byline>Hyperlinking to our Content</Byline>
      ...
      <p>
        ...
        visibility of the hyperlink compensates the absence of {title}; and (d) the link is in the
      ...
      <p>
        ...
        linking to our website, you must inform us by sending an e-mail to {title}. Please include
      ...
      <p>
        No use of {title}&apos;s logo or other artwork will be allowed for linking absent a
        trademark license agreement.
      </p>

      <Byline>iFrames</Byline>
      ...
      <Byline>Content Liability</Byline>
      ...
      <Byline>Your Privacy</Byline>

      <p>
        Please read our <Link to="/privacy">Privacy Policy</Link>
      </p>

      <Byline>Reservation of Rights</Byline>
      ...
      <Byline>Removal of links from our website</Byline>
